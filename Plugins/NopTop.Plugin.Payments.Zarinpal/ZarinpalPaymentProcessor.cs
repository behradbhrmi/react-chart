...
namespace NopTop.Plugin.Payments.Zarinpal
{
    ...
    public class ZarinPalPaymentProcessor : BasePlugin, IPaymentMethod, IAdminMenuPlugin
    {
        ...
        public async Task PostProcessPaymentAsync(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            var irrCurrency = await _currencyService.GetCurrencyByCodeAsync("IRR");
            total =Convert.ToInt32( await _currencyService.ConvertCurrencyAsync(total, primaryCurrency,irrCurrency));
